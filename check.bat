...
EXIT /B 1
:lbl_235___end
IF "%~2"=="dforest" GOTO lbl_237_dforest
IF "%~2"=="dforest_silent" GOTO lbl_237_dforest_silent
IF "%~2"=="dforest_short" GOTO lbl_237_dforest_short
IF "%~2"=="tsort" GOTO lbl_237_tsort
IF "%~2"=="tsort_silent" GOTO lbl_237_tsort_silent
IF "%~2"=="tsort_short" GOTO lbl_237_tsort_short
IF "%~2"=="descriptivestatistics" GOTO lbl_237_descriptivestatistics
IF "%~2"=="descriptivestatistics_silent" GOTO lbl_237_descriptivestatistics_silent
IF "%~2"=="descriptivestatistics_short" GOTO lbl_237_descriptivestatistics_short
IF "%~2"=="bdss" GOTO lbl_237_bdss
IF "%~2"=="bdss_silent" GOTO lbl_237_bdss_silent
IF "%~2"=="bdss_short" GOTO lbl_237_bdss_short
IF "%~2"=="kmeans" GOTO lbl_237_kmeans
IF "%~2"=="kmeans_silent" GOTO lbl_237_kmeans_silent
IF "%~2"=="kmeans_short" GOTO lbl_237_kmeans_short
IF "%~2"=="blas" GOTO lbl_237_blas
IF "%~2"=="blas_silent" GOTO lbl_237_blas_silent
IF "%~2"=="blas_short" GOTO lbl_237_blas_short
IF "%~2"=="lda" GOTO lbl_237_lda
IF "%~2"=="lda_silent" GOTO lbl_237_lda_silent
IF "%~2"=="lda_short" GOTO lbl_237_lda_short
IF "%~2"=="rotations" GOTO lbl_237_rotations
IF "%~2"=="rotations_silent" GOTO lbl_237_rotations_silent
IF "%~2"=="rotations_short" GOTO lbl_237_rotations_short
IF "%~2"=="tdevd" GOTO lbl_237_tdevd
IF "%~2"=="tdevd_silent" GOTO lbl_237_tdevd_silent
IF "%~2"=="tdevd_short" GOTO lbl_237_tdevd_short
IF "%~2"=="sblas" GOTO lbl_237_sblas
IF "%~2"=="sblas_silent" GOTO lbl_237_sblas_silent
IF "%~2"=="sblas_short" GOTO lbl_237_sblas_short
IF "%~2"=="reflections" GOTO lbl_237_reflections
IF "%~2"=="reflections_silent" GOTO lbl_237_reflections_silent
IF "%~2"=="reflections_short" GOTO lbl_237_reflections_short
IF "%~2"=="tridiagonal" GOTO lbl_237_tridiagonal
IF "%~2"=="tridiagonal_silent" GOTO lbl_237_tridiagonal_silent
IF "%~2"=="tridiagonal_short" GOTO lbl_237_tridiagonal_short
IF "%~2"=="sevd" GOTO lbl_237_sevd
IF "%~2"=="sevd_silent" GOTO lbl_237_sevd_silent
IF "%~2"=="sevd_short" GOTO lbl_237_sevd_short
IF "%~2"=="creflections" GOTO lbl_237_creflections
IF "%~2"=="creflections_silent" GOTO lbl_237_creflections_silent
IF "%~2"=="creflections_short" GOTO lbl_237_creflections_short
IF "%~2"=="hqrnd" GOTO lbl_237_hqrnd
IF "%~2"=="hqrnd_silent" GOTO lbl_237_hqrnd_silent
IF "%~2"=="hqrnd_short" GOTO lbl_237_hqrnd_short
IF "%~2"=="matgen" GOTO lbl_237_matgen
IF "%~2"=="matgen_silent" GOTO lbl_237_matgen_silent
IF "%~2"=="matgen_short" GOTO lbl_237_matgen_short
IF "%~2"=="ablasf" GOTO lbl_237_ablasf
IF "%~2"=="ablasf_silent" GOTO lbl_237_ablasf_silent
IF "%~2"=="ablasf_short" GOTO lbl_237_ablasf_short
IF "%~2"=="ablas" GOTO lbl_237_ablas
IF "%~2"=="ablas_silent" GOTO lbl_237_ablas_silent
IF "%~2"=="ablas_short" GOTO lbl_237_ablas_short
IF "%~2"=="trfac" GOTO lbl_237_trfac
IF "%~2"=="trfac_silent" GOTO lbl_237_trfac_silent
IF "%~2"=="trfac_short" GOTO lbl_237_trfac_short
IF "%~2"=="spdinverse" GOTO lbl_237_spdinverse
IF "%~2"=="spdinverse_silent" GOTO lbl_237_spdinverse_silent
IF "%~2"=="spdinverse_short" GOTO lbl_237_spdinverse_short
IF "%~2"=="linreg" GOTO lbl_237_linreg
IF "%~2"=="linreg_silent" GOTO lbl_237_linreg_silent
IF "%~2"=="linreg_short" GOTO lbl_237_linreg_short
IF "%~2"=="gammafunc" GOTO lbl_237_gammafunc
IF "%~2"=="gammafunc_silent" GOTO lbl_237_gammafunc_silent
IF "%~2"=="gammafunc_short" GOTO lbl_237_gammafunc_short
IF "%~2"=="normaldistr" GOTO lbl_237_normaldistr
IF "%~2"=="normaldistr_silent" GOTO lbl_237_normaldistr_silent
IF "%~2"=="normaldistr_short" GOTO lbl_237_normaldistr_short
IF "%~2"=="igammaf" GOTO lbl_237_igammaf
IF "%~2"=="igammaf_silent" GOTO lbl_237_igammaf_silent
IF "%~2"=="igammaf_short" GOTO lbl_237_igammaf_short
IF "%~2"=="bidiagonal" GOTO lbl_237_bidiagonal
IF "%~2"=="bidiagonal_silent" GOTO lbl_237_bidiagonal_silent
IF "%~2"=="bidiagonal_short" GOTO lbl_237_bidiagonal_short
IF "%~2"=="qr" GOTO lbl_237_qr
IF "%~2"=="qr_silent" GOTO lbl_237_qr_silent
IF "%~2"=="qr_short" GOTO lbl_237_qr_short
IF "%~2"=="lq" GOTO lbl_237_lq
IF "%~2"=="lq_silent" GOTO lbl_237_lq_silent
IF "%~2"=="lq_short" GOTO lbl_237_lq_short
IF "%~2"=="bdsvd" GOTO lbl_237_bdsvd
IF "%~2"=="bdsvd_silent" GOTO lbl_237_bdsvd_silent
IF "%~2"=="bdsvd_short" GOTO lbl_237_bdsvd_short
IF "%~2"=="svd" GOTO lbl_237_svd
IF "%~2"=="svd_silent" GOTO lbl_237_svd_silent
IF "%~2"=="svd_short" GOTO lbl_237_svd_short
IF "%~2"=="logit" GOTO lbl_237_logit
IF "%~2"=="logit_silent" GOTO lbl_237_logit_silent
IF "%~2"=="logit_short" GOTO lbl_237_logit_short
IF "%~2"=="mlpbase" GOTO lbl_237_mlpbase
IF "%~2"=="mlpbase_silent" GOTO lbl_237_mlpbase_silent
IF "%~2"=="mlpbase_short" GOTO lbl_237_mlpbase_short
IF "%~2"=="trlinsolve" GOTO lbl_237_trlinsolve
IF "%~2"=="trlinsolve_silent" GOTO lbl_237_trlinsolve_silent
IF "%~2"=="trlinsolve_short" GOTO lbl_237_trlinsolve_short
IF "%~2"=="safesolve" GOTO lbl_237_safesolve
IF "%~2"=="safesolve_silent" GOTO lbl_237_safesolve_silent
IF "%~2"=="safesolve_short" GOTO lbl_237_safesolve_short
IF "%~2"=="rcond" GOTO lbl_237_rcond
IF "%~2"=="rcond_silent" GOTO lbl_237_rcond_silent
IF "%~2"=="rcond_short" GOTO lbl_237_rcond_short
IF "%~2"=="xblas" GOTO lbl_237_xblas
IF "%~2"=="xblas_silent" GOTO lbl_237_xblas_silent
IF "%~2"=="xblas_short" GOTO lbl_237_xblas_short
IF "%~2"=="densesolver" GOTO lbl_237_densesolver
IF "%~2"=="densesolver_silent" GOTO lbl_237_densesolver_silent
IF "%~2"=="densesolver_short" GOTO lbl_237_densesolver_short
IF "%~2"=="mlpe" GOTO lbl_237_mlpe
IF "%~2"=="mlpe_silent" GOTO lbl_237_mlpe_silent
IF "%~2"=="mlpe_short" GOTO lbl_237_mlpe_short
IF "%~2"=="trinverse" GOTO lbl_237_trinverse
IF "%~2"=="trinverse_silent" GOTO lbl_237_trinverse_silent
IF "%~2"=="trinverse_short" GOTO lbl_237_trinverse_short
IF "%~2"=="lbfgs" GOTO lbl_237_lbfgs
IF "%~2"=="lbfgs_silent" GOTO lbl_237_lbfgs_silent
IF "%~2"=="lbfgs_short" GOTO lbl_237_lbfgs_short
IF "%~2"=="mlptrain" GOTO lbl_237_mlptrain
IF "%~2"=="mlptrain_silent" GOTO lbl_237_mlptrain_silent
IF "%~2"=="mlptrain_short" GOTO lbl_237_mlptrain_short
IF "%~2"=="pca" GOTO lbl_237_pca
IF "%~2"=="pca_silent" GOTO lbl_237_pca_silent
IF "%~2"=="pca_short" GOTO lbl_237_pca_short
IF "%~2"=="odesolver" GOTO lbl_237_odesolver
IF "%~2"=="odesolver_silent" GOTO lbl_237_odesolver_silent
IF "%~2"=="odesolver_short" GOTO lbl_237_odesolver_short
IF "%~2"=="conv" GOTO lbl_237_conv
IF "%~2"=="conv_silent" GOTO lbl_237_conv_silent
IF "%~2"=="conv_short" GOTO lbl_237_conv_short
IF "%~2"=="ftbase" GOTO lbl_237_ftbase
IF "%~2"=="ftbase_silent" GOTO lbl_237_ftbase_silent
IF "%~2"=="ftbase_short" GOTO lbl_237_ftbase_short
IF "%~2"=="fft" GOTO lbl_237_fft
IF "%~2"=="fft_silent" GOTO lbl_237_fft_silent
IF "%~2"=="fft_short" GOTO lbl_237_fft_short
IF "%~2"=="corr" GOTO lbl_237_corr
IF "%~2"=="corr_silent" GOTO lbl_237_corr_silent
IF "%~2"=="corr_short" GOTO lbl_237_corr_short
IF "%~2"=="fht" GOTO lbl_237_fht
IF "%~2"=="fht_silent" GOTO lbl_237_fht_silent
IF "%~2"=="fht_short" GOTO lbl_237_fht_short
IF "%~2"=="autogk" GOTO lbl_237_autogk
IF "%~2"=="autogk_silent" GOTO lbl_237_autogk_silent
IF "%~2"=="autogk_short" GOTO lbl_237_autogk_short
IF "%~2"=="gq" GOTO lbl_237_gq
IF "%~2"=="gq_silent" GOTO lbl_237_gq_silent
IF "%~2"=="gq_short" GOTO lbl_237_gq_short
IF "%~2"=="gkq" GOTO lbl_237_gkq
IF "%~2"=="gkq_silent" GOTO lbl_237_gkq_silent
IF "%~2"=="gkq_short" GOTO lbl_237_gkq_short
IF "%~2"=="lsfit" GOTO lbl_237_lsfit
IF "%~2"=="lsfit_silent" GOTO lbl_237_lsfit_silent
IF "%~2"=="lsfit_short" GOTO lbl_237_lsfit_short
IF "%~2"=="minlm" GOTO lbl_237_minlm
IF "%~2"=="minlm_silent" GOTO lbl_237_minlm_silent
IF "%~2"=="minlm_short" GOTO lbl_237_minlm_short
IF "%~2"=="spline3" GOTO lbl_237_spline3
IF "%~2"=="spline3_silent" GOTO lbl_237_spline3_silent
IF "%~2"=="spline3_short" GOTO lbl_237_spline3_short
IF "%~2"=="leastsquares" GOTO lbl_237_leastsquares
IF "%~2"=="leastsquares_silent" GOTO lbl_237_leastsquares_silent
IF "%~2"=="leastsquares_short" GOTO lbl_237_leastsquares_short
IF "%~2"=="polint" GOTO lbl_237_polint
IF "%~2"=="polint_silent" GOTO lbl_237_polint_silent
IF "%~2"=="polint_short" GOTO lbl_237_polint_short
IF "%~2"=="ratinterpolation" GOTO lbl_237_ratinterpolation
IF "%~2"=="ratinterpolation_silent" GOTO lbl_237_ratinterpolation_silent
IF "%~2"=="ratinterpolation_short" GOTO lbl_237_ratinterpolation_short
IF "%~2"=="ratint" GOTO lbl_237_ratint
IF "%~2"=="ratint_silent" GOTO lbl_237_ratint_silent
IF "%~2"=="ratint_short" GOTO lbl_237_ratint_short
IF "%~2"=="taskgen" GOTO lbl_237_taskgen
IF "%~2"=="taskgen_silent" GOTO lbl_237_taskgen_silent
IF "%~2"=="taskgen_short" GOTO lbl_237_taskgen_short
IF "%~2"=="spline2d" GOTO lbl_237_spline2d
IF "%~2"=="spline2d_silent" GOTO lbl_237_spline2d_silent
IF "%~2"=="spline2d_short" GOTO lbl_237_spline2d_short
IF "%~2"=="spline1d" GOTO lbl_237_spline1d
IF "%~2"=="spline1d_silent" GOTO lbl_237_spline1d_silent
IF "%~2"=="spline1d_short" GOTO lbl_237_spline1d_short
IF "%~2"=="hessenberg" GOTO lbl_237_hessenberg
IF "%~2"=="hessenberg_silent" GOTO lbl_237_hessenberg_silent
IF "%~2"=="hessenberg_short" GOTO lbl_237_hessenberg_short
IF "%~2"=="cdet" GOTO lbl_237_cdet
IF "%~2"=="cdet_silent" GOTO lbl_237_cdet_silent
IF "%~2"=="cdet_short" GOTO lbl_237_cdet_short
IF "%~2"=="cinverse" GOTO lbl_237_cinverse
IF "%~2"=="cinverse_silent" GOTO lbl_237_cinverse_silent
IF "%~2"=="cinverse_short" GOTO lbl_237_cinverse_short
IF "%~2"=="ctrinverse" GOTO lbl_237_ctrinverse
IF "%~2"=="ctrinverse_silent" GOTO lbl_237_ctrinverse_silent
IF "%~2"=="ctrinverse_short" GOTO lbl_237_ctrinverse_short
IF "%~2"=="cqr" GOTO lbl_237_cqr
IF "%~2"=="cqr_silent" GOTO lbl_237_cqr_silent
IF "%~2"=="cqr_short" GOTO lbl_237_cqr_short
IF "%~2"=="det" GOTO lbl_237_det
IF "%~2"=="det_silent" GOTO lbl_237_det_silent
IF "%~2"=="det_short" GOTO lbl_237_det_short
IF "%~2"=="spddet" GOTO lbl_237_spddet
IF "%~2"=="spddet_silent" GOTO lbl_237_spddet_silent
IF "%~2"=="spddet_short" GOTO lbl_237_spddet_short
IF "%~2"=="sdet" GOTO lbl_237_sdet
IF "%~2"=="sdet_silent" GOTO lbl_237_sdet_silent
IF "%~2"=="sdet_short" GOTO lbl_237_sdet_short
IF "%~2"=="ldlt" GOTO lbl_237_ldlt
IF "%~2"=="ldlt_silent" GOTO lbl_237_ldlt_silent
IF "%~2"=="ldlt_short" GOTO lbl_237_ldlt_short
IF "%~2"=="spdgevd" GOTO lbl_237_spdgevd
IF "%~2"=="spdgevd_silent" GOTO lbl_237_spdgevd_silent
IF "%~2"=="spdgevd_short" GOTO lbl_237_spdgevd_short
IF "%~2"=="htridiagonal" GOTO lbl_237_htridiagonal
IF "%~2"=="htridiagonal_silent" GOTO lbl_237_htridiagonal_silent
IF "%~2"=="htridiagonal_short" GOTO lbl_237_htridiagonal_short
IF "%~2"=="cblas" GOTO lbl_237_cblas
IF "%~2"=="cblas_silent" GOTO lbl_237_cblas_silent
IF "%~2"=="cblas_short" GOTO lbl_237_cblas_short
IF "%~2"=="hblas" GOTO lbl_237_hblas
IF "%~2"=="hblas_silent" GOTO lbl_237_hblas_silent
IF "%~2"=="hblas_short" GOTO lbl_237_hblas_short
IF "%~2"=="hbisinv" GOTO lbl_237_hbisinv
IF "%~2"=="hbisinv_silent" GOTO lbl_237_hbisinv_silent
IF "%~2"=="hbisinv_short" GOTO lbl_237_hbisinv_short
IF "%~2"=="tdbisinv" GOTO lbl_237_tdbisinv
IF "%~2"=="tdbisinv_silent" GOTO lbl_237_tdbisinv_silent
IF "%~2"=="tdbisinv_short" GOTO lbl_237_tdbisinv_short
IF "%~2"=="hevd" GOTO lbl_237_hevd
IF "%~2"=="hevd_silent" GOTO lbl_237_hevd_silent
IF "%~2"=="hevd_short" GOTO lbl_237_hevd_short
IF "%~2"=="inv" GOTO lbl_237_inv
IF "%~2"=="inv_silent" GOTO lbl_237_inv_silent
IF "%~2"=="inv_short" GOTO lbl_237_inv_short
IF "%~2"=="sinverse" GOTO lbl_237_sinverse
IF "%~2"=="sinverse_silent" GOTO lbl_237_sinverse_silent
IF "%~2"=="sinverse_short" GOTO lbl_237_sinverse_short
IF "%~2"=="inverseupdate" GOTO lbl_237_inverseupdate
IF "%~2"=="inverseupdate_silent" GOTO lbl_237_inverseupdate_silent
IF "%~2"=="inverseupdate_short" GOTO lbl_237_inverseupdate_short
IF "%~2"=="nsevd" GOTO lbl_237_nsevd
IF "%~2"=="nsevd_silent" GOTO lbl_237_nsevd_silent
IF "%~2"=="nsevd_short" GOTO lbl_237_nsevd_short
IF "%~2"=="hsschur" GOTO lbl_237_hsschur
IF "%~2"=="hsschur_silent" GOTO lbl_237_hsschur_silent
IF "%~2"=="hsschur_short" GOTO lbl_237_hsschur_short
IF "%~2"=="srcond" GOTO lbl_237_srcond
IF "%~2"=="srcond_silent" GOTO lbl_237_srcond_silent
IF "%~2"=="srcond_short" GOTO lbl_237_srcond_short
IF "%~2"=="ssolve" GOTO lbl_237_ssolve
IF "%~2"=="ssolve_silent" GOTO lbl_237_ssolve_silent
IF "%~2"=="ssolve_short" GOTO lbl_237_ssolve_short
IF "%~2"=="estnorm" GOTO lbl_237_estnorm
IF "%~2"=="estnorm_silent" GOTO lbl_237_estnorm_silent
IF "%~2"=="estnorm_short" GOTO lbl_237_estnorm_short
IF "%~2"=="schur" GOTO lbl_237_schur
IF "%~2"=="schur_silent" GOTO lbl_237_schur_silent
IF "%~2"=="schur_short" GOTO lbl_237_schur_short
IF "%~2"=="sbisinv" GOTO lbl_237_sbisinv
IF "%~2"=="sbisinv_silent" GOTO lbl_237_sbisinv_silent
IF "%~2"=="sbisinv_short" GOTO lbl_237_sbisinv_short
IF "%~2"=="airyf" GOTO lbl_237_airyf
IF "%~2"=="airyf_silent" GOTO lbl_237_airyf_silent
IF "%~2"=="airyf_short" GOTO lbl_237_airyf_short
IF "%~2"=="bessel" GOTO lbl_237_bessel
IF "%~2"=="bessel_silent" GOTO lbl_237_bessel_silent
IF "%~2"=="bessel_short" GOTO lbl_237_bessel_short
IF "%~2"=="betaf" GOTO lbl_237_betaf
IF "%~2"=="betaf_silent" GOTO lbl_237_betaf_silent
IF "%~2"=="betaf_short" GOTO lbl_237_betaf_short
IF "%~2"=="chebyshev" GOTO lbl_237_chebyshev
IF "%~2"=="chebyshev_silent" GOTO lbl_237_chebyshev_silent
IF "%~2"=="chebyshev_short" GOTO lbl_237_chebyshev_short
IF "%~2"=="dawson" GOTO lbl_237_dawson
IF "%~2"=="dawson_silent" GOTO lbl_237_dawson_silent
IF "%~2"=="dawson_short" GOTO lbl_237_dawson_short
IF "%~2"=="elliptic" GOTO lbl_237_elliptic
IF "%~2"=="elliptic_silent" GOTO lbl_237_elliptic_silent
IF "%~2"=="elliptic_short" GOTO lbl_237_elliptic_short
IF "%~2"=="expintegrals" GOTO lbl_237_expintegrals
IF "%~2"=="expintegrals_silent" GOTO lbl_237_expintegrals_silent
IF "%~2"=="expintegrals_short" GOTO lbl_237_expintegrals_short
IF "%~2"=="fresnel" GOTO lbl_237_fresnel
IF "%~2"=="fresnel_silent" GOTO lbl_237_fresnel_silent
IF "%~2"=="fresnel_short" GOTO lbl_237_fresnel_short
IF "%~2"=="hermite" GOTO lbl_237_hermite
IF "%~2"=="hermite_silent" GOTO lbl_237_hermite_silent
IF "%~2"=="hermite_short" GOTO lbl_237_hermite_short
IF "%~2"=="ibetaf" GOTO lbl_237_ibetaf
IF "%~2"=="ibetaf_silent" GOTO lbl_237_ibetaf_silent
IF "%~2"=="ibetaf_short" GOTO lbl_237_ibetaf_short
IF "%~2"=="jacobianelliptic" GOTO lbl_237_jacobianelliptic
IF "%~2"=="jacobianelliptic_silent" GOTO lbl_237_jacobianelliptic_silent
IF "%~2"=="jacobianelliptic_short" GOTO lbl_237_jacobianelliptic_short
IF "%~2"=="laguerre" GOTO lbl_237_laguerre
IF "%~2"=="laguerre_silent" GOTO lbl_237_laguerre_silent
IF "%~2"=="laguerre_short" GOTO lbl_237_laguerre_short
IF "%~2"=="legendre" GOTO lbl_237_legendre
IF "%~2"=="legendre_silent" GOTO lbl_237_legendre_silent
IF "%~2"=="legendre_short" GOTO lbl_237_legendre_short
IF "%~2"=="psif" GOTO lbl_237_psif
IF "%~2"=="psif_silent" GOTO lbl_237_psif_silent
IF "%~2"=="psif_short" GOTO lbl_237_psif_short
IF "%~2"=="trigintegrals" GOTO lbl_237_trigintegrals
IF "%~2"=="trigintegrals_silent" GOTO lbl_237_trigintegrals_silent
IF "%~2"=="trigintegrals_short" GOTO lbl_237_trigintegrals_short
IF "%~2"=="binomialdistr" GOTO lbl_237_binomialdistr
IF "%~2"=="binomialdistr_silent" GOTO lbl_237_binomialdistr_silent
IF "%~2"=="binomialdistr_short" GOTO lbl_237_binomialdistr_short
IF "%~2"=="nearunityunit" GOTO lbl_237_nearunityunit
IF "%~2"=="nearunityunit_silent" GOTO lbl_237_nearunityunit_silent
IF "%~2"=="nearunityunit_short" GOTO lbl_237_nearunityunit_short
IF "%~2"=="chisquaredistr" GOTO lbl_237_chisquaredistr
IF "%~2"=="chisquaredistr_silent" GOTO lbl_237_chisquaredistr_silent
IF "%~2"=="chisquaredistr_short" GOTO lbl_237_chisquaredistr_short
IF "%~2"=="correlation" GOTO lbl_237_correlation
IF "%~2"=="correlation_silent" GOTO lbl_237_correlation_silent
IF "%~2"=="correlation_short" GOTO lbl_237_correlation_short
IF "%~2"=="fdistr" GOTO lbl_237_fdistr
IF "%~2"=="fdistr_silent" GOTO lbl_237_fdistr_silent
IF "%~2"=="fdistr_short" GOTO lbl_237_fdistr_short
IF "%~2"=="correlationtests" GOTO lbl_237_correlationtests
IF "%~2"=="correlationtests_silent" GOTO lbl_237_correlationtests_silent
IF "%~2"=="correlationtests_short" GOTO lbl_237_correlationtests_short
IF "%~2"=="studenttdistr" GOTO lbl_237_studenttdistr
IF "%~2"=="studenttdistr_silent" GOTO lbl_237_studenttdistr_silent
IF "%~2"=="studenttdistr_short" GOTO lbl_237_studenttdistr_short
IF "%~2"=="jarquebera" GOTO lbl_237_jarquebera
IF "%~2"=="jarquebera_silent" GOTO lbl_237_jarquebera_silent
IF "%~2"=="jarquebera_short" GOTO lbl_237_jarquebera_short
IF "%~2"=="mannwhitneyu" GOTO lbl_237_mannwhitneyu
IF "%~2"=="mannwhitneyu_silent" GOTO lbl_237_mannwhitneyu_silent
IF "%~2"=="mannwhitneyu_short" GOTO lbl_237_mannwhitneyu_short
IF "%~2"=="poissondistr" GOTO lbl_237_poissondistr
IF "%~2"=="poissondistr_silent" GOTO lbl_237_poissondistr_silent
IF "%~2"=="poissondistr_short" GOTO lbl_237_poissondistr_short
IF "%~2"=="stest" GOTO lbl_237_stest
IF "%~2"=="stest_silent" GOTO lbl_237_stest_silent
IF "%~2"=="stest_short" GOTO lbl_237_stest_short
IF "%~2"=="studentttests" GOTO lbl_237_studentttests
IF "%~2"=="studentttests_silent" GOTO lbl_237_studentttests_silent
IF "%~2"=="studentttests_short" GOTO lbl_237_studentttests_short
IF "%~2"=="variancetests" GOTO lbl_237_variancetests
IF "%~2"=="variancetests_silent" GOTO lbl_237_variancetests_silent
IF "%~2"=="variancetests_short" GOTO lbl_237_variancetests_short
IF "%~2"=="wsr" GOTO lbl_237_wsr
IF "%~2"=="wsr_silent" GOTO lbl_237_wsr_silent
IF "%~2"=="wsr_short" GOTO lbl_237_wsr_short
GOTO lbl_237___error
:lbl_237_dforest
COPY _internal\_run_testforestunit.pas _tmp\_test.pas > NUL 2> NUL
COPY tests\testforestunit.* _tmp > NUL 2> NUL
GOTO lbl_237___end
:lbl_237_dforest_short
COPY _internal\_run_short_testforestunit.pas _tmp\_test.pas > NUL 2> NUL
COPY tests\testforestunit.* _tmp > NUL 2> NUL
GOTO lbl_237___end
:lbl_237_dforest_silent
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_rotations_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_rotations_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_tdevd
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_ablasf_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_ablasf_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_ablas
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_normaldistr_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_normaldistr_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_igammaf
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_igammaf_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_igammaf_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_bidiagonal
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_mlpbase_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_mlpbase_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_trlinsolve
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_ftbase_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_ftbase_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_fft
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_spline3_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_spline3_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_leastsquares
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_237___end
:lbl_237_leastsquares_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_leastsquares_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_polint
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_taskgen_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_taskgen_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_spline2d
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_spddet_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_spddet_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_sdet
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_hsschur_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_hsschur_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_srcond
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_ssolve_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_ssolve_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_estnorm
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_estnorm_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_estnorm_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_schur
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_bessel_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_bessel_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_betaf
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_dawson_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_dawson_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_elliptic
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_elliptic_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_elliptic_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_expintegrals
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_237___end
:lbl_237_expintegrals_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_expintegrals_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_fresnel
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_fresnel_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_fresnel_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_hermite
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_ibetaf_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_ibetaf_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_jacobianelliptic
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_237___end
:lbl_237_jacobianelliptic_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_jacobianelliptic_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_laguerre
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_trigintegrals
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_237___end
:lbl_237_trigintegrals_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_trigintegrals_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_binomialdistr
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_237___end
:lbl_237_binomialdistr_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_binomialdistr_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_nearunityunit
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_237___end
:lbl_237_nearunityunit_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_nearunityunit_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_chisquaredistr
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_237___end
:lbl_237_chisquaredistr_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_chisquaredistr_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_correlation
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_correlation_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_correlation_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_fdistr
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_fdistr_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_fdistr_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_correlationtests
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_237___end
:lbl_237_correlationtests_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_correlationtests_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_studenttdistr
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_237___end
:lbl_237_studenttdistr_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_studenttdistr_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_jarquebera
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_jarquebera_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_jarquebera_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_mannwhitneyu
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_237___end
:lbl_237_mannwhitneyu_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_mannwhitneyu_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_poissondistr
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_237___end
:lbl_237_poissondistr_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_poissondistr_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_stest
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_237___end
:lbl_237_stest_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_studentttests
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_237___end
:lbl_237_studentttests_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_studentttests_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_variancetests
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_237___end
:lbl_237_variancetests_short
EXIT /B 0
GOTO lbl_237___end
:lbl_237_variancetests_silent
EXIT /B 0
GOTO lbl_237___end
:lbl_237_wsr
echo No separate test file for this unit
