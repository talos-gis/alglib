...
function SPDMatrixInverse(var A : TReal2DArray;
     N : AlglibInteger;
     IsUpper : Boolean):Boolean;
function InverseCholesky(var A : TReal2DArray;
     N : AlglibInteger;
     IsUpper : Boolean):Boolean;
function InverseSymmetricPositiveDefinite(var A : TReal2DArray;
     N : AlglibInteger;
     IsUpper : Boolean):Boolean;
...
begin
    ...
    begin
        ...
        begin
            ...
            if I<N then
            begin
                V := APVDotProduct(@A[I][0], I, N, @A[I][0], I, N);
                A[I,I] := V;
                IP1 := I+1;
                K:=1;
                while K<=I-1 do
                begin
                    V := APVDotProduct(@A[K][0], IP1, N, @A[I][0], IP1, N);
                    A[K,I] := A[K,I]*AII+V;
                    Inc(K);
                end;
            end
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                while I<=N do
                begin
                    V := APVDotProduct(@A[I][0], JP1, I, @T[0], JP1, I);
                    A[I,J] := V;
                    Inc(I);
                end;
                for i_ := JP1 to N do
...
begin
    ...
    begin
        if InverseCholesky(A, N, IsUpper) then
        begin
            Result := True;
        end;
    end;
