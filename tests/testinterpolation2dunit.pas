...
interface
uses Math, Sysutils, Ap, spline3, blas, trinverse, cholesky, spdsolve, lbfgs, minlm, reflections, bidiagonal, qr, lq, rotations, bdsvd, svd, lu, trlinsolve, rcond, leastsquares, lsfit, spline1d, spline2d;
