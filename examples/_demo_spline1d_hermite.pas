...
begin
    ...
    //
    Write(Format('INTERPOLATION BY HERMITE SPLINE'#13#10''#13#10'',[]));
    ...
    Spline1DBuildHermite(X, Y, D, N, S);
    ...
    Write(Format('max|error| = %0.3f'#13#10'',[
        MaxErr]));
    Write(Format('Try other demos (spline1d_linear, spline1d_cubic) and compare errors...'#13#10''#13#10''#13#10'',[]));
end.